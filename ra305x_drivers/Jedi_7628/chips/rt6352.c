	...
	IN	PRTMP_ADAPTER	pAd)
{
	...
	for (i=0; i<5; i++)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("20MHz BW, 2.4G band-%lx,  Gdata = %lx \n", data, Gdata));
	}
	...
	IN BOOLEAN ReInit)
{
	...
	if (pAd->bExtPA)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Enable Ext-PA. init MAC \n", __FUNCTION__));
	...
	if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Enable Ext-LNA. \n", __FUNCTION__));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Enable Ext-PA. \n", __FUNCTION__));
	...
	if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Init Ext-LNA BBP. \n", __FUNCTION__));
	...
	if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->bExtPA))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Init Ext-PA MAC. \n", __FUNCTION__));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pAd->bExtPA)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-PA. init MAC \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-LNA. \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->bExtPA))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-PA. \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-LNA BBP. \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->bExtPA))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-PA MAC. \n", __FUNCTION__));
