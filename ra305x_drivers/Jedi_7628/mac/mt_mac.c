...
#ifdef MAC_REPEATER_SUPPORT
           CliIdx = mac_entry->MatchReptCliIdx;
#endif /* MAC_REPEATER_SUPPORT */
#ifdef MULTI_APCLI_SUPPORT
#ifdef MAC_REPEATER_SUPPORT
		if ((pAd->ApCfg.bMACRepeaterEn == TRUE) && (mac_entry->bReptCli) && CliIdx != 0xFF)
			txd_1->own_mac = (0x1 + mac_entry->func_tb_idx + CliIdx + 32);
		else
#endif /* MAC_REPEATER_SUPPORT */
...
#ifdef TMR_SUPPORT
            if ((pAd->TmrRole == TMR_INITIATOR) && (txd_2->timing_measure == 1)) {
...
#ifdef MAC_REPEATER_SUPPORT
		CliIdx = pMacEntry->MatchReptCliIdx;
#endif /* MAC_REPEATER_SUPPORT */
#if 0
...
#ifdef MULTI_APCLI_SUPPORT
#ifdef MAC_REPEATER_SUPPORT
		if ((pAd->ApCfg.bMACRepeaterEn == TRUE) && (pMacEntry->bReptCli) && CliIdx != 0xFF)
			txd_1->own_mac = (0x1 + pMacEntry->func_tb_idx + CliIdx + 32);
		else
#endif /* MAC_REPEATER_SUPPORT */
