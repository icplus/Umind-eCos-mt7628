...
INT
Set_FtmLciValue_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);

INT 
Set_FtmLciLat_ThisAP_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);

INT 
Set_FtmLciLng_ThisAP_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);

INT 
Set_FtmLciAlt_ThisAP_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);
...
INT 
Show_FtmPidList_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);

INT 
Show_FtmLciValue_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);
...
VOID 
FtmProfileNeighborApParse(
    IN RTMP_ADAPTER *pAd,
    IN UINT NeighborIdx, 
    IN RTMP_STRING *tmpbuf);

INT 
Send_ANQP_Req_For_Test(
	IN PRTMP_ADAPTER pAd,
	IN RTMP_STRING *arg
	);
INT
Send_NeighborReq_For_Test(
	IN PRTMP_ADAPTER pAd,
	IN RTMP_STRING *arg);

INT 
Set_FtmRMRandomizationInterval_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);

INT 
Set_FtmRMMinimumApCount_Proc(
	IN RTMP_ADAPTER *pAd, 
	IN RTMP_STRING *arg
	);

INT 
Send_RadioMeasurement_Req_For_Test(
	IN PRTMP_ADAPTER pAd,
	IN RTMP_STRING *arg);
