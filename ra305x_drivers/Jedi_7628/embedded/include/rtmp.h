...
#define FIFO_RSV_FOR_HIGH_PRIORITY 	8
...
#if 0 /* debug */
	UINT8 dbg_ra_info_index;
	RA_INFO dbg_ra_info[30];
#endif
#endif /* NEW_RATE_ADAPT_SUPPORT */
...
#endif /* MAC_REPEATER_SUPPORT */
	/*add for connection status*/
	UCHAR ApcliConnectState;
	UCHAR ApcliFailReason;
	UCHAR ApcliFailReasonMax,ApcliFailReasonMaxTemp;
...
#if 1 //woraround for Reset next few times , if PSE Reset Fails.
...
#endif /* DATA_QUEUE_RESERVE */
	/* add for record TxRxCoherent Counter */
	UINT32 TxCoherentCnt;
	UINT32 RxCoherentCnt;
};
...
#ifdef BANDWIDTH_10_SUPPORT
INT Set_Bw5Bw10_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
#endif
...
VOID TxRxCheck(RTMP_ADAPTER *pAd);
