...
INT trace_iparp_usage(PRTMP_ADAPTER ad, RTMP_STRING *arg);
...
INT trace_iparp_set_tx_ignored_pnt(PRTMP_ADAPTER ad, RTMP_STRING *arg);
INT trace_iparp_set_rx_ignored_pnt(PRTMP_ADAPTER ad, RTMP_STRING *arg);
