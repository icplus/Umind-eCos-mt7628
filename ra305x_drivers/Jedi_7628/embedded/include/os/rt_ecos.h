...
#define AP_DRIVER_VERSION			"4.1.0.0_CL150742"
...
#define STA_DRIVER_VERSION			"3.0.0.0-Beta1"
#ifdef MULTIPLE_CARD_SUPPORT
...
/* Debug Level */
#define  RT_DEBUG_OFF   DBG_LVL_OFF		
#define  RT_DEBUG_ERROR DBG_LVL_ERROR	
#define  RT_DEBUG_WARN  DBG_LVL_WARN	
#define  RT_DEBUG_TRACE DBG_LVL_TRACE	
#define  RT_DEBUG_INFO DBG_LVL_INFO	
...
#else
#define RX_RING_SIZE            64 /*64 */
#define TX_RING_SIZE            40 /*64 */
#define RX1_RING_SIZE			64

#endif
#ifdef DATA_QUEUE_RESERVE
// TX_RING_SIZE_RSV must small than TX_RING_SIZE
#define TX_RING_SIZE_RSV    6
