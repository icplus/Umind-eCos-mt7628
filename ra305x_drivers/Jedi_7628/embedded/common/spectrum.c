	...
	IN UINT8 *ChReptList)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: Requlatory class (%d), NumberOfChannels=%d, pChannelSet->NumberOfChannels=%d, (%d,%d,%d,%d)\n",
						__FUNCTION__, RegulatoryClass,NumberOfChannels,pChannelSet->NumberOfChannels, ChReptList[0],ChReptList[1],ChReptList[2],ChReptList[3]));
