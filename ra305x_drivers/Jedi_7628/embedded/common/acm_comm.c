...
#define WMM_ACM_FUNC_NAME_PRINT(__pMsg)	\
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("acm_func> %s: %s\n", __FUNCTION__, __pMsg));
...
/*	if (ACMP_IsAnyACEnabled(pAd) != ACM_RTN_OK)
	...
	*/
	...
	if (pStream != NULL)
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_err> Tx Time > 0xFFFF us!\n"));
		} /* End of if */
	...
	ACM_PARAM_IN	UCHAR					*pDatlBwMax)
{
	...
	if (!ACMR_IS_ENABLED(pAd))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> WMM ACM is disabled!\n"));
		return;
	} /* End of if */
	...
	*/
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> DATL reset!\n"));
	return;
	...
	ACM_PARAM_IN	UINT32					PhyRate)
{
	...
	*/
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> discard ACM action frame!\n"));
		return ACM_RTN_FAIL;
	} /* End of if */

	if (SubType != ACMR_SUBTYPE_ACTION)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> drop non ACM action frame!\n"));
	...
	ACM_PARAM_IN	ACMR_STA_DB				*pCdb)
{
        ...
        (pCdb->bAPSDDeliverEnabledPerAC[QID_AC_VO] == 1))
    {
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> all AC are UAPSD!\n"));
    }
    else
    {
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> not all AC are UAPSD!\n"));
    } /* End of if */
	...
	ACM_PARAM_IN	UCHAR					StreamType)
{
	...
	*/
	...
	if (Status != ACM_RTN_OK)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Old TSPEC does not exist!\n"));
	...
	ACM_PARAM_IN	UINT16				DialogToken)
{
	...
	{
		ACM_TSPEC_SEM_UNLOCK(pAd, LabelSemErr);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> ACM is not allowed!\n"));
		return ACM_RTN_DISALLOW;
	} /* End of if */
	...
	*/
	...
	if (ACMP_IsAnyACEnabled(pAd) != ACM_RTN_OK)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> ACM is disabled!\n"));
		return ACM_RTN_DISALLOW;
	} /* End of if */
#endif /* ACM_CC_FUNC_SPEC_CHANGE_TG */
 	...
 	ACM_PARAM_IN	PRTMP_ADAPTER	pAd)
{
	...
	if (FlgIsEnabled == TRUE)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Enable retry!\n"));
	}
	else
	{
		ACMR_RETRY_DISABLE(pAd);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Disable retry %x!\n",
	...
	ACM_PARAM_IN	UCHAR					FlgIsApsdEnable)
{
	...
	if (ACMR_IS_AP_MODE(pAd))
	{
			...
			(FlgIsDeEnabled == pCdb->bAPSDDeliverEnabledPerAC[AcId]))
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> No change for PS mode!\n"));
			return;
		} /* End of if */
	...
	ACM_PARAM_IN	ACM_STREAM				*pReqNew)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Make up a ADDTS Request...\n"));
	...
	ACM_PARAM_IN	ACM_STREAM				*pStream)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Make up a DELTS to QAP...\n"));
	...
	ACM_PARAM_IN	ACM_STREAM				*pStream)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Make up a DELTS to QSTA...\n"));
...
LabelAllocFail:
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("acm_err> Allocate peer device entry fail!\n"));
	return ACM_RTN_FAIL;
	...
	ACM_PARAM_IN	ACM_STREAM			*pStreamReq)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> TC_Active()!\n"));
	...
	ACM_PARAM_IN	ACM_STREAM			*pReqNew)
{
	...
	else
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> req already exist!\n"));
	...
	ACM_PARAM_IN	UCHAR					FlgIsForceToSent)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Make up a BW ANN...\n"));
	...
	ACM_PARAM_IN	PRTMP_ADAPTER	pAd)
{
	...
	/* for all rates */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> calculate frame body tx time...\n"));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> calculate other tx time...\n"));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> pre-calculattion ok!\n"));
#endif /* ACM_CC_FUNC_AUX_TX_TIME */
	...
	if (Category == ACM_CATEGORY_WME)
	{
		...
		if (Action == ACM_ACTION_WME_SETUP_REQ)
		{
			...
			if (StatusCode != ACM_STATUS_CODE_PRIVATE_ACM_DISABLED)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> prepare to response...\n"));
	...
	ACM_PARAM_OUT	UINT16				*pMediumTime)
{
	...
	*pMediumTime = 0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> UP = %d\n", UserPriority));
...
/* #endif */
		...
		*/
		...
		switch(Status)
		{
			case ACM_RTN_FAIL:
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> new TSPEC!\n"));
				break;

			case ACM_RTN_OK:
				/* this is negotiated request */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> same TSPEC!\n"));
	...
	/* HCCA is not support */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> HCCA is not supported!\n"));
	StatusCode = ACM_STATUS_CODE_DECLINED;
	RtnCode = ACM_RTN_DISALLOW;
	goto LabelRspErr;
...
#define TC_LMR_STREAM_DESTROY(__pAd, __StmAcId, __pStreamReq)	\
	...
	*/
	...
	if (ACMR_CB->EdcaCtrlParam.FlgAcmStatus[ACM_MR_EDCA_AC(pStreamReq->UP)] == 0)
	{
		...
		/* change PS mode only because ACM is disabled */
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Only change PS mode!\n"));
