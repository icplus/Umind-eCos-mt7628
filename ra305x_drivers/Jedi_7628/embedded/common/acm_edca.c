	...
	ACM_PARAM_IN	ACM_STREAM				*pOldStreamDiffAc)
{
	...
	if (pOldStreamIn != NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Free in stream!\n"));
		ACM_TC_Discard(pAd, pOldStreamIn);
	} /* End of if */

	if (pOldStreamOut != NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Free out stream!\n"));
		ACM_TC_Discard(pAd, pOldStreamOut);
	} /* End of if */

	if (pOldStreamDiffAc != NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Free dif stream!\n"));
	...
	ACM_PARAM_IN	UCHAR					StatusCode)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("acm_msg> Make up a ADDTS response...\n"));
