	...
	IN	UINT			Len)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("RTMPTkipCompareMICValueWithLLC(): TKIP MIC Error !\n"));  /*MIC error.*/
	
#ifdef RELEASE_EXCLUDE
		{
			INT		i;
		
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Orig MIC value ="));  /*MIC error.*/
			for (i = 0; i < 8; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%02x:", OldMic[i]));  /*MIC error.*/
			}
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("\n"));  /*MIC error.*/
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Calculated MIC value ="));  /*MIC error.*/
			for (i = 0; i < 8; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%02x:", pAd->PrivateInfo.Rx.MIC[i]));  /*MIC error.*/
			}
	...
	IN	UINT			Len)
{
	...
	if(!NdisEqualMemory(pAd->PrivateInfo.Rx.MIC, OldMic, 8))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("RTMPTkipCompareMICValue(): TKIP MIC Error !\n"));  /*MIC error.*/
