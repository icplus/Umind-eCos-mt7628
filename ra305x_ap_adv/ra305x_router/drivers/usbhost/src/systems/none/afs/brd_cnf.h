...
/*
*   0: Port 0 can upgrade
*   1: Only Port 1 can upgrade
*/
#ifndef LOADER_UPGRADE_USB_PORT_SUPPORT
#define LOADER_UPGRADE_USB_PORT_SUPPORT     (0)   
#endif
...
#define MUSB_BT_TIMER_IDX  (MUSB_HID_TIMER_IDX + MUSB_HID_TIMER)
