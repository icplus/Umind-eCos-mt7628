...
#ifndef __MUSB_NONE_PLATFORM_ARCH_H__
#define __MUSB_NONE_PLATFORM_ARCH_H__

/*
 * uC/OS-II platform-specific architecture definitions
 * $Revision: #1 $
 */
