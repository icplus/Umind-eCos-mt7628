 ...
 *---------------------------------------------------------------------------*/
#ifndef __MUSB_LINUX_MU_SYSTEM_H__
#define __MUSB_LINUX_MU_SYSTEM_H__
...
/**
 * Introduction to uC/OS-II UDSI implementation.
 * Since uC/OS-II does not provide abstract support for timers or interrupt
 * handling, this port must delegate these operations to target-specific code.
 * Target-specific code (expected in <Target>/board.c) needs to implement:
 * <dl>
 * <dt>MUSB_ReadConsole
 ...
 * <dd>Called by the uC/OS implementation of MUSB_InitSystem
 * <dt>MUSB_BoardInitTimers
 * <dd>Called by the uC/OS implementation of MUSB_InitSystem
 * <dt>MUSB_BoardDestroyController
 * <dd>Called by the uC/OS implementation of MUSB_DestroySystem
 ...
 */
extern MUSB_UcosController MUSB_aUcosController[];
 ...
 */
extern void* MUSB_BoardInitController(void* pPrivateData, MUSB_pfUcosIsr pfIsr,
...
extern uint8_t MUSB_BoardArmTimer(void* pPrivateData, uint16_t wIndex, 
			     ...
			     x_os_timer_cb_fct pfExpireCallback,
			     void* pParam);
...
/**
 * Board-specific Query interrupt status.
 * @param pPrivateData result of a successful call to MUSB_BoardInitController
 * on the corresponding controller
 * @return interrupt status.
 */
extern uint32_t MUSB_BoardIsIrqPending(void *pPrivateData);
