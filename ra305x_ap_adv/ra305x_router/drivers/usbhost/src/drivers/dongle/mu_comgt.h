...
/***************************************************************************
* $Id: //WIFI_SOC/release/SDK_4_1_0_0/source/user/comgt-0.32/comgt.h#1 $
****************************************************************************/
...
char *get_code(char* name){
  ...
  if (strcmp(name,"generic_conn")==0) return (_generic_conn);
