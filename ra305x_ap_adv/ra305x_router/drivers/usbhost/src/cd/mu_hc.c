...
//  MTK Notice: Max Liao, 2006/11/10.
//  add MUSB_OTG to support host only mode in dual role controller.
...
MUSB_BusHandle MUSB_RegisterHostClient(MUSB_Port *pPort, MUSB_HostClient *pHostClient)
{
    void *pResult = NULL;
    MGC_Port *pImplPort;
