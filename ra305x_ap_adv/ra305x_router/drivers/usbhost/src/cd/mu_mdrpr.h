...
*/
extern int32_t MGC_MhdrcDumpState(MGC_Controller* pController);

/*
* Dump info relevant to the given local endpoint resource
*/
extern int32_t MGC_MhdrcDumpEndpoint(MGC_Controller* pController, MUSB_EndpointResource* pEnd);
