...
#if (CC_DRV_LOG_LVL>=0)
#define LOG_0(fmt...)			diag_printf(fmt)
#else
#define LOG_0(fmt...)
#endif
...
#define LOG_1(fmt...)			diag_printf(fmt)
#else
#define LOG_1(fmt...)
#endif
...
#define LOG_2(fmt...)			diag_printf(fmt)
...
LOG_MOD_DECLARE(CLI);
LOG_MOD_DECLARE(FAT);
LOG_MOD_DECLARE(FEEDER);
LOG_MOD_DECLARE(MID);
LOG_MOD_DECLARE(PVR);
LOG_MOD_DECLARE(PCMCIA);
LOG_MOD_DECLARE(DV);
...
LOG_MOD_DECLARE(PDWNC);
LOG_MOD_DECLARE(RTC);
LOG_MOD_DECLARE(NAV);
LOG_MOD_DECLARE(PSIPSR);
LOG_MOD_DECLARE(BLKMGR);
LOG_MOD_DECLARE(JPG);
LOG_MOD_DECLARE(PNG); 
LOG_MOD_DECLARE(WEBP);
LOG_MOD_DECLARE(SWDMX);
LOG_MOD_DECLARE(MUXER);
LOG_MOD_DECLARE(PLAYMGR);
LOG_MOD_DECLARE(EXTMJC);
LOG_MOD_DECLARE(GDMA);
LOG_MOD_DECLARE(FVR);
LOG_MOD_DECLARE(VDEC);
LOG_MOD_DECLARE(VOMX);
LOG_MOD_DECLARE(VENC);
LOG_MOD_DECLARE(NIM);
LOG_MOD_DECLARE(LINUX);
LOG_MOD_DECLARE(MEMTEST);
LOG_MOD_DECLARE(MUTE);
LOG_MOD_DECLARE(SCPOS);
LOG_MOD_DECLARE(NR);
LOG_MOD_DECLARE(DI);
LOG_MOD_DECLARE(OS);
LOG_MOD_DECLARE(CEC);
LOG_MOD_DECLARE(GCPU);
LOG_MOD_DECLARE(EXTRA);
*/
#endif /* __X_DEBUG_H__ */
