...
/*
 * MUSBStack-S USB Software Platform bit-manipulation library API.
 * $Revision: #2 $
 */
 ...
 */
extern int32_t MUSB_BitsGet(const uint8_t* pBuffer, uint8_t bOffset, uint8_t bCount,
uint32_t* pdwResult);
 ...
 */
#if 0 
extern int32_t MUSB_BitsSet(uint8_t* pBuffer, uint8_t bOffset, uint8_t bCount,
uint32_t dwValue);
#endif
