...
/*
 * MUSBStack-S Communication Device Class (CDC) definitions.
 * $Revision: #2 $
 */

#ifndef __MUSB_CDC_IF_H__
#define __MUSB_CDC_IF_H__

/**
 * Transfer completion callback.
 * Read and write are asynchronous requests, so the implementation
 ...
 */
//-------------------------------------------------------------------------
extern INT32 MUSB_CdcConfigOK(void);
 ...
 */
//-------------------------------------------------------------------------
extern INT32 MUSB_CdcSyncTx(UINT8 *pBuf, UINT32 dwCount);
 ...
 */
//-------------------------------------------------------------------------
extern INT32 MUSB_CdcAsyncTx(UINT8 *pBuf, UINT32 dwCount, 
 ...
 */
//-------------------------------------------------------------------------
extern INT32 MUSB_CdcSyncRx(UINT8 *pBuf, UINT32 dwCount);
