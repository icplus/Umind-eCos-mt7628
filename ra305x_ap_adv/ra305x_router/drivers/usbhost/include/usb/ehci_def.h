...
//#define EHCI_virt_to_bus(x) (((unsigned long)(x)) & 0x1fffffff)

//added Jody
#define EHCI_REGS_BASE        0xb01c0000
#define EHCI_CAPS_HC_CAPBASE  (EHCI_REGS_BASE)
#define EHCI_CAPS_HCS_PARAMS  (EHCI_REGS_BASE + 0x4)
#define EHCI_CAPS_HCC_PARAMS  (EHCI_REGS_BASE + 0x8)

#define EHCI_REGS_COMMAND     (EHCI_REGS_BASE + 0x10)
#define EHCI_REGS_STATUS      (EHCI_REGS_BASE + 0x14)
#define EHCI_REGS_INTR_ENABLE (EHCI_REGS_BASE + 0x18)
#define EHCI_REGS_FRAME_INDEX (EHCI_REGS_BASE + 0x1c)
#define EHCI_REGS_SEGMENT     (EHCI_REGS_BASE + 0x20)
#define EHCI_REGS_FRAME_LIST  (EHCI_REGS_BASE + 0x24)
#define EHCI_REGS_ASYNC_NEXT  (EHCI_REGS_BASE + 0x28)

#define EHCI_REGS_CONFIGFLAG  (EHCI_REGS_BASE + 0x50)
#define EHCI_REGS_PORT_STATUS  (EHCI_REGS_BASE + 0x54)
