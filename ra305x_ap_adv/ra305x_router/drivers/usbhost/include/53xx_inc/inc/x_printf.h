...
extern CHAR* lltoa(CHAR* dst, UINT64 u8Val, UINT32 u4Radix);

#ifndef CC_MWIF2

#ifndef printf
#define printf      Printf      //lint !e683 function #define'd
#endif
...
#endif // defined(__KERNEL__) && !defined(CC_MTK_PRELOADER)
