...
#define FATFS_HASH_TABLE_SIZE 32

#define FATFS_NODE_POOL_SIZE  32
#define CYGNUM_FS_FAT_BLOCK_CACHE_MEMSIZE 256*512
...
#define FM_MAX_FILE_LEN (256-1) //Maximum length of a filename
...
{
    char              filename[4*(FM_MAX_FILE_LEN+1)]; // File name
    char              short_name[12]; // File name
