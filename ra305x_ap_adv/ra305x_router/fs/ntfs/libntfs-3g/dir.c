 ...
 * Return 0 on success or -1 on error with errno set to the error code.
 */
extern int ntfs_link_i(ntfs_inode *ni, ntfs_inode *dir_ni, const ntfschar *name,
