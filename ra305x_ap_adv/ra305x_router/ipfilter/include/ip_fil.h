 ...
 * $Id: ip_fil.h,v 1.1 2010/01/28 11:09:57 dennis Exp $
 */
...
#define FM_OURSPORT	0x01000000 /* 11/05/04 Roger, whether it is ours packet */	
#define FM_BADNAT	0x02000000 /* 04/02/05 Roger,  this flag will be set if no memory for NAT */	
...
typedef	struct	frentry {
	...
	struct	fr_ip	fr_tip;	/* 24/12/03 Roger,  top ip */	

	u_short	fr_icmpm;	/* data for ICMP packets (mask) */
	u_short	fr_icmp;
	
	fract_t  fract;	/* 24/12/03 Roger,  duration for rule active */	
	...
	u_short fr_seclog;	/* 16/02/04 Roger, ugly, use it map security log string */	
} frentry_t;
...
#define fr_tsrc		fr_tip.fi_src.in4
#define fr_tdst		fr_tip.fi_dst.in4
#define fr_inact	fract.frinact
#define fr_actm		fract.frt_mode
#define fr_actd		fract.frt_day
#define fr_actst	fract.frtime[0]
#define fr_actet	fract.frtime[1]
...
#define FR_SEC_LOG	0x80000000	/* 16/02/04 Roger,  security log */	
#define FR_INACTIVE_SCHED	0x40000000	/* 05/11/04 Roger,  inactive rule due to schedular match */	
...
#if 0 /* 10/03/04 Roger ++,  */	
#define ASSEMBLE_MBUF(x)	assemble_mbuf(x) 
#else
#define ASSEMBLE_MBUF(x)	1
#endif /* 10/03/04 Roger --,  */	
/*
...
extern  void fr_ip5tup_timeout(void);
#endif
